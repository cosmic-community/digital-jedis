export const metadata = {
  title: 'Contact Us - Digital Jedis',
      ...
      <section className="section-padding bg-secondary-50">
        <div className="container-custom">
          <div className="grid md:grid-cols-2 gap-12">
            {/* Contact Info */}
            <div>
              <h2 className="heading-3 text-secondary-900 mb-6">Get in Touch</h2>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-secondary-600">hello@digitaljedis.com</p>
                  </div>
                </div>
            ...
            <div className="card p-8">
              <h2 className="heading-3 text-secondary-900 mb-6">Send us a Message</h2>
